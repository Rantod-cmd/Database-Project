                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="backdrop-blur-md bg-white/80 border border-slate-200/60 rounded-2xl shadow-card p-8 md:p-10">
                        ...
                        <div className="flex flex-col items-center mb-8">
                            ...
                            <h1 className="text-2xl font-extrabold text-slate-900 mb-1">สมัครสมาชิก</h1>
                            <p className="text-sm text-slate-500">ลงทะเบียนเข้าใช้งานระบบโรงพยาบาลเครือข่าย</p>
                        </div>
                        ...
                        <form onSubmit={handleRegister} className="space-y-5">
                            ...
                            {confirmPassword && (
                                <div className={`flex items-center gap-2 text-xs font-medium ${password === confirmPassword ? 'text-primary' : 'text-red-500'}`}>
                        ...
                        <div className="text-center">
                            <p className="text-sm text-slate-500 mb-2">มีบัญชีแล้ว?</p>
                            <button
